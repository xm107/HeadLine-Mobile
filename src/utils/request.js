...
const instance = axios.create({
  ...
  transformResponse: [function (data) {
    //   data就是后端响应回来的字符串
    // JSON.parse()
    return data ? JSONBig.parse(data) : {} // ---->try catch方式也行
  }]
}) // 创建一个axios的新实例
...
export default instance // instance拥有axios的所有方法
